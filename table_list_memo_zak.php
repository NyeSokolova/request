                            ...
                            <div class="col-1-medium">
                                <table>
                                    <tr>
                                        ...
                                        <th class='noedit'>Описание</th>
                                        <th class='noedit'>ТЗ</th>
                                        <th class='noedit'>Статус служебной записки</th>
                                    </tr>
<!--                                    <td>-->
<!--                                        <div class="col-12">-->
<!--                                            <ul class="actions">-->
<!--                                                <li><input type="submit" value="Просмотр" class="primary" /></li></ul>-->
...
<!--                                    </td>-->
                                    ...
                                    <td data-type='text'>
                                        ВН125485 Служебная записка на персональное рабочее место. Принтер, сканер-копир. Флеш-накопитель, телефонный аппарат.
                                    </td>
                                    <td>
                                        Согласовано
                                    </td>
